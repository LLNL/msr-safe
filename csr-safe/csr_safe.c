// Author: Scott Walker
// csr_entry.c
// Kernel module to provide safe access to pcie config space
...
static __u32 BAR_PCI_DID = 0x0;
static __u32 BAR_PCI_OFFT = 0x0;
...
#endif // LINUX_VERSION
{
	// this is a pcie device but the data is actually
	// from the processor
