...
static struct msr_whitelist whitelist[] = {
	...
	MSR_RW(SMSR_PMC6),
	MSR_RW(SMSR_PMC7),
	MSR_RW(SMSR_PLATFORM_INFO),
	MSR_RO(SMSR_MPERF),
	MSR_RO(SMSR_APERF),
	MSR_RW(SMSR_PERFEVTSEL0),
	MSR_RW(SMSR_PERFEVTSEL1),
	MSR_RW(SMSR_PERFEVTSEL2),
	MSR_RW(SMSR_PERFEVTSEL3),
	MSR_RW(SMSR_PERFEVTSEL4),
	MSR_RW(SMSR_PERFEVTSEL5),
	MSR_RW(SMSR_PERFEVTSEL6),
	MSR_RW(SMSR_PERFEVTSEL7),
	MSR_RO(SMSR_PERF_STATUS),
	MSR_RW(SMSR_PERF_CTL),
	MSR_RW(SMSR_CLOCK_MODULATION),
	MSR_RW(SMSR_THERM_INTERRUPT),
	MSR_RO(SMSR_THERM_STATUS),
	MSR_RW(SMSR_MISC_ENABLE),
	MSR_RW(SMSR_TEMPERATURE_TARGET),
	MSR_RW(SMSR_OFFCORE_RSP_0),
	MSR_RW(SMSR_OFFCORE_RSP_1),
	MSR_RW(SMSR_MISC_PWR_MGMT),
	MSR_RW(SMSR_ENERGY_PERF_BIAS),
	MSR_RO(SMSR_PACKAGE_THERM_STATUS),
	MSR_RW(SMSR_PACKAGE_THERM_INTERRUPT),
	MSR_RW(SMSR_POWER_CTL),
	MSR_RW(SMSR_FIXED_CTR0),
	MSR_RW(SMSR_FIXED_CTR1),
	MSR_RW(SMSR_FIXED_CTR2),
	MSR_RW(SMSR_PERF_CAPABILITIES),
	MSR_RW(SMSR_FIXED_CTR_CTRL),
	MSR_RO(SMSR_PERF_GLOBAL_STATUS),
	MSR_RW(SMSR_PERF_GLOBAL_CTRL),
	MSR_RW(SMSR_PERF_GLOBAL_OVF_CTRL),
	MSR_RW(SMSR_PEBS_ENABLE),
	MSR_RW(SMSR_PEBS_LD_LAT),
	MSR_RW(SMSR_RAPL_POWER_UNIT),
	MSR_RW(SMSR_PKG_POWER_LIMIT),
	MSR_RO(SMSR_PKG_ENERGY_STATUS),
	MSR_RW(SMSR_PKG_POWER_INFO),
	MSR_RW(SMSR_PP0_POWER_LIMIT),
	MSR_RO(SMSR_PP0_ENERGY_STATUS),
	MSR_RO(SMSR_TSC_DEADLINE),
	MSR_RW(SMSR_TURBO_RATIO_LIMIT),
	MSR_RW(SMSR_MSR_PEBS_NUM_ALT),
	MSR_RO(SMSR_MSR_PKG_PERF_STATUS), 
	MSR_RW(SMSR_DRAM_POWER_LIMIT), 
	MSR_RO(SMSR_DRAM_ENERGY_STATUS),
	MSR_RO(SMSR_DRAM_PERF_STATUS),
	MSR_RW(SMSR_DRAM_POWER_INFO)
};
